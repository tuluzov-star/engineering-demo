    ...
    <main>
      <section className="hero shell">
        <div>
          ...
          <p className="hero__lead">
            ...
            experience. Docker makes the stack reproducible, and GitHub Actions verifies
            every change.
          </p>
        </div>
      ...
      <section className="architecture shell" aria-labelledby="architecture-title">
        ...
        <div className="architecture-grid">
          <article><span>01</span><h3>Commerce backend</h3><p>WordPress 7.1 + WooCommerce 11.1, isolated behind public APIs and a tiny custom REST plugin.</p></article>
          <article><span>02</span><h3>Frontend</h3><p>Next.js 16 App Router with Server Components fetching WooCommerce Store API data.</p></article>
